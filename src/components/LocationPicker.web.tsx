...
const styles = StyleSheet.create({
  ...
  container: { padding: 16, paddingBottom: 130, backgroundColor: colors.background },
  ...
  mapCard: { borderRadius: 12, overflow: "hidden", backgroundColor: colors.surface, marginBottom: 18 },
  mapArea: { height: 230, backgroundColor: "#DDF4FF", alignItems: "center", justifyContent: "center", position: "relative" },
  ...
  card: { backgroundColor: colors.surface, borderRadius: 12, padding: 18, marginBottom: 18 },
