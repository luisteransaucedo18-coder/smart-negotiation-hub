...
export default function LandingScreen({ onLogin, onRegister }: { onLogin: () => void; onRegister: () => void }) {
  return (
    <View>
      ...
      <AppButton title="Ingresar" icon="login" onPress={onLogin} />
      <AppButton title="Crear cuenta" icon="account-plus-outline" onPress={onRegister} variant="secondary" />
    </View>
  );
}
...
const styles = StyleSheet.create({
  ...
  promiseBox: { backgroundColor: colors.surface, borderRadius: 20, borderWidth: 1, borderColor: colors.border, padding: 14, marginBottom: 6 },
  ...
  storyBox: { backgroundColor: colors.ink, borderRadius: 20, padding: 16, marginBottom: 12 },
